...
const editView = (req, res) => {
    axios
        .get("http://localhost:3000/api/v1/Cars/" + req.params.id)
        .then((response) => {
...
const filterResult = (req, res) => {
    axios
        .get("http://localhost:3000/api/v1/FilterCars/" + req.params.id)
        .then((response) => {
            res.render("index", {cars: response.data, moment: moment});
        })
        .catch((error) => {
...
const searchResult = (req, res) => {
    if (req.body.search === "" || req.body.search === null) {
        ...
        axios
            .get("http://localhost:3000/api/v1/SearchCars/" + req.body.search)
            .then((response) => {
                res.render("index", {cars: response.data, moment: moment});
            })
            .catch((error) => {
